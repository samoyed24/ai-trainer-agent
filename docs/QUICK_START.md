...
# 设置配置
ai-trainer-config set backend.api https://... --type str
...
ai-trainer-config set backend.api https://... --type str
ai-trainer-config set backend.app_id your_app_id --type str
ai-trainer-config set backend.app_secret your_secret --type str
ai-trainer-config set backend.timeout 10 --type int

# 服务器
ai-trainer-config set server.url https://... --type str
ai-trainer-config set server.timeout 10 --type int
ai-trainer-config set server.retry_count 3 --type int

# Agent
ai-trainer-config set agent.upload_frequency epoch --type str
ai-trainer-config set agent.upload_interval 1 --type int
ai-trainer-config set agent.enable_async true --type bool
